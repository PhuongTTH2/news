            ...
            <div className="container no-padding-lr">
              <div id="my-congrats">
                ...
                <div className="scoresWrapper">
                  ...
                  <br />
                  <p>
                    You must answer at least 25% of the Religious Match Survey items
                    for this requirement to be active.
                  </p>
                  ...
                  <p>
                    “Answering a section” means answering one or more questions within
                    that section (marking a blank section as ‘answered’ does not
                    count).
                  </p>
                  <br />
                ...
                <ol>
                  ...
                  <li>
                    Begin posting content (communications, documents, videos, polls,
                    etc.) in your NRM’s lounge page
                  </li>
                </ol>
                <div className="pr-btns">
                  ...
                  <div className="pr-btn">
                    <a href="/lounge">Begin Posting in Lounge</a>
                  </div>
                  <div className="pr-btn">
                    <a href="#">Complete Religious Match Survey items</a>
                    <small>(recommended for brand new religions like yours)*</small>
                  </div>
                </div>
              </div>{" "}
              {/* #my-please-read */}
