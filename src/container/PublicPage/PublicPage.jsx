            ...
            <div className="sibar-inner-wrapper">
              ...
              <div className="card featuredNRM">
                ...
                <div className="card-body">
                  ...
                  <p className="fs--12">
                    Jordanism subscribes to the idea that people through life
                    hidden from their true selves and that life is a consistent
                    struggle to realize one's true and enduring nature...
                  </p>
                </div>
              </div>
              {/* end of card */}
              ...
              <div className="card mt--5 impt-weight">
                ...
                <div className="card-body">
                  <p className="fs--11">
                    Overall, how important are each of the following aspects of
                    the religion(s) you affiliate with?
                    <br />
                ...
                <div className="rateBarWrapper1">
                  ...
                  <p className="fs--11">
                    How the religion is actually physically and mentally
                    practiced
                  </p>
                  <div className="rateBar">
                    <div className="progHolder">
              ...
              <div className="card mt--5 no-bottom-border reg-desires">
                ...
                <div className="card-body">
                  <p className="fs--11">
                    ...
                    link to the full survey. The more items you complete, the
                    better your NRM matches will be.
                  </p>
                  ...
                  <div className="checkboxListWrapper">
                    <form>
                      ...
                      <div className="form-group">
                        <label>
                          <input type="checkbox" />
                          God has a plan for all life, the planet and the
                          universe.
                        </label>
                      </div>
                      <div className="form-group">
                  ...
                  <div>
                    <a
                      href="/"
                      className="float-left colorDarkRed fw--400 clear"
                    >
