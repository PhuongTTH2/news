            ...
            <div className="holder">
              ...
              <div className="width271_right">
                <div className="qouteWrapper">
                  ...
                  <a
                    href="/"
                    className="no-text-decoration fw--600 float-right"
                  >
                      ...
                      return (
                        <div className="author mt--5">
                          ...
                          <p className="fs--12">
                            ...
                            <br />
                            <small className="fs--12">{item.message}</small>
                          </p>
                          <div className="clearfix" />
                        </div>
                      );
              ...
              <div className="updatesContent pb--20">
                <div className="textTitle">
                  <p className="fs--12">
                    ...
                    bbq. <br />{" "}
                    <strong>
                      November 1, 3-5 PM / Timber Creek Park (map)
                    </strong>
                  </p>
                </div>
                <a
                ...
                <div className="card-body">
                  ...
                  <div className="member mt--10">
                    ...
                    <p className="fs--12 auth-name">
                      <a href="/" className="bright-blue">
                        Jordan Holtzman{" "}
                        <span className="loc">(Berkeley, CA)</span>
                      </a>
                      <br />
                      Founder
                    </p>
                    <div className="clearfix" />
                    <p className="fs--12">
                      <span className="fw--700 blue">Board Service:</span> 2
                      years, 3 months
                      <br />
                      <span className="fw--700 blue">Affiliation:</span> 4
                      years, 7 months
                    </p>
                    <div className="intro">
                      <p className="fs--12">
                        <span className="fw--700 blue">Introduction:</span>{" "}
                        Welcome to Jordanism. I look forward to interacting with
                        you soon.
                      </p>
                    </div>
                    <div className="intro">
                      <p className="fs--12">
                        <span className="fw--700 blue">Bio:</span> I was born in
                        New York and came to the West Coast almost two decades
                        ago. I’m really into gardening, food, and creative
                        projects.
                      </p>
                    </div>
                    <p className="fs--10">
                  ...
                  <div className="member mt--10">
                    ...
                    <p className="fs--12 auth-name">
                      <a href="/" className="bright-blue">
                        Vince Truong{" "}
                        <span className="loc">(St. Louis, MO)</span>
                      </a>
                      <br />
                    ...
                    <div className="clearfix" />
                    <p className="fs--12">
                      <span className="fw--700 blue">Board Service:</span> 1
                      years, 2 months
                      <br />
                      <span className="fw--700  blue">Affiliation:</span> 3
                      years, 6 months
                    </p>
                    <div className="intro">
                      <p className="fs--12">
                        <span className="fw--700 blue">Introduction:</span> I
                        hope Jordanism does for you all the great things it has
                        done for me.
                      </p>
                    </div>
                    <div className="intro">
                  ...
                  <div className="member mt--10">
                    ...
                    <div className="clearfix" />
                    <p className="fs--12">
                      <span className="fw--700 blue">Board Service:</span> 0
                      years, 8 months
                      <br />
                      <span className="fw--700 blue">Affiliation:</span> 1
                      years, 9 months
                    </p>
                    <div className="intro">
                      <p className="fs--12 blue">
                        <span className="fw--700">Introduction:</span> Hi, I’m
                        the guy that jots it all down!
                      </p>
                    </div>
                    <div className="intro">
                      <p className="fs--12 blue">
                        <span className="fw--700">Bio:</span> I enjoy water
                        skiing and traveling the world in my free time. You’ll
                        hopefully find that I have a great sense of humor.
                      </p>
                    </div>
                    <p className="fs--10">
                      <a href="/" className="bright-blue">
            ...
            <div className="modal-body">
              ...
              <div className="create-cont">
                ...
                <div className="create-inner addButton">
                  <a href="/">
                    <img alt="alt" src="img/icon-add.png" /> add another answer
                    choice
                  </a>
                </div>
                ...
                <div className="create-inner pb--20">
                  <label>
                    <input type="checkbox" /> Show results while poll is in
                    process
                  </label>
                </div>
                ...
                <table id="pollTable" className="table table-bordered">
                  <thead>
                    <tr>
                      <th className="noBorderTop noBorderLeft noBorderBottom">
                        {" "}
                      </th>
                      <th colSpan={2}>
            ...
            <div className="modal-body">
              <div className="create-cont">
                ...
                <table id="eventTable" className="table table-bordered">
                  <thead>
                    <tr>
                      <th className="noBorderTop noBorderBottom noBorderLeft">
                        {" "}
                      </th>
                      <th colSpan={4}>
                        Initial Poll Posting Permissions <br />
              ...
              <div className="create-cont">
                ...
                <div className="create-inner addButton pb--20">
                  <label className="custom-file-upload">
                    <input type="file" />
                    <img alt="alt" src="img/icon-add.png" /> Add
                    Video/Images/file
                  </label>
                </div>
                <div className="create-inner pb--20">
                  <label>
                    <input type="checkbox" /> &nbsp;&nbsp; Co-post image, video
                    or file to Resource Archives
                  </label>
                </div>
                <div className="create-inner f--width"></div>
                <div className="create-inner usePermissions">
                ...
                <table id="communicationTable" className="table table-bordered">
                  <thead>
                    <tr>
                      <th className="noBorderLeft noBorderTop noBorderBottom">
                        {" "}
                      </th>
                      <th colSpan={3}>Check which users can…</th>
                    </tr>
